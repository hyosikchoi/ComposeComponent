package com.hyosik.di

import com.google.gson.FieldNamingPolicy
import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.hyosik.composecomponent.GithubService
import com.hyosik.composecomponent.PokeAPI
...
//        GsonBuilder().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES) // snake 케이스로 서버에서 날라와도 camel 케이스로 변환 해서 받을 수 있다.
//            .create()
//
//    @Singleton
//    @Provides
